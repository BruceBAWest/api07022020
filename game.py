...
while True:
    ...
    if 'item' in rooms[currentRoom] and 'monster' in rooms[currentRoom]['item'] and 'baseball bat' in inventory:
        print(
            "There is a monster here! Thinking quickly, you swing your baseball bat at the monsters head. Given he is soft from years of eating cookies, he immeidately perishes.")
