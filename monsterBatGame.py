...
while True:
    ...
    if 'item' in rooms[currentRoom] and 'monster' in rooms[currentRoom]['item'] and 'baseball bat' in inventory:
        print(
            "There\'s a monster here! You swing your baseball bat at his head and shout, \"LUCILLE!\" The monster dies! You cheer, \"Leroy Jenkins!\"")
    ...
    if currentRoom == 'Garden' and 'key' in inventory and 'potion' in inventory:
        print('You escaped the haunted castle with the ultra rare key and magic potion... YOU WIN!')
        break
